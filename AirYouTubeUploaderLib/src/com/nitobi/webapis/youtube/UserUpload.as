package com.nitobi.webapis.youtube
{
	...
	public class UserUpload
	{
		...
		public var keywords:String = "SpyCam";
		public var description:String = "SpyCam capture";
		...
		static public var getDescription:Function = null;
		...
		public static function create(filePath:String):UserUpload
		{
			...
			upload.file = file;
			upload.description = getDescription!=null ? getDescription() : "SpyCam " + new Date().toLocaleString();
